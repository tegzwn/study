...
void SmearImage(unsigned char imageData[HEIGHT][WIDTH], unsigned char smearedImage[HEIGHT][WIDTH]);
void ShiftImage(unsigned char imageData[HEIGHT][WIDTH], int shiftX, int shiftY, unsigned char shiftedImage[HEIGHT][WIDTH]);
